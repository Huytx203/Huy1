          ...
          <div className="flex justify-center gap-6">
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              <div className="text-blue-500 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-12 w-12 mx-auto">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 1</h2>
              <p className="text-gray-600">Tiếp nhận thông tin, tìm hiểu nhu cầu của doanh nghiệp.</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 2</h2>
              <p className="text-gray-600">Set up tài khoản.</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 3</h2>
              <p className="text-gray-600">Phân tích doanh nghiệp, thị trường và nhắm vào mục tiêu quảng cáo.</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 4</h2>
              <p className="text-gray-600">Lên kế hoạch cụ thể, chuẩn bị nội dung.</p>
            </div>
          </div>
          <div className="flex justify-center gap-6 ">
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 5</h2>
              <p className="text-gray-600">Triển khai quảng cáo.</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 6</h2>
              <p className="text-gray-600">Đo lường và tối ưu.</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center w-64">
              ...
              <h2 className="text-xl font-semibold mb-2">Bước 7</h2>
              <p className="text-gray-600">Báo cáo định kỳ.</p>
            </div>
          </div>
        </div>
      </main>
